...
employee_meetings = db.Table(
    "employee_meetings",
    metadata, db.Column("employee_id",db.Integer, db.ForeignKey('employees.id'),primary_key=True),
...
class Assignment(db.Model):
    ...
    def __repr__(self):
        return f'<Assignments {self.id}, {self.role}, {self.start_date}, {self.end_date}, {self.employee.name}, {self.project.title}>'
